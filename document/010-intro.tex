...
% importance in various domains such as machine learning, computer vision, natural
% language processing, and more. Briefly mention the rapid advancements in neural
% network architectures and techniques that have led to significant breakthroughs.
...
\Cref{sec:theoretical_background} gives an overview of the theoretical background
...
and the wrappers used to interface with them from \emph{Julia}. \Cref{sec:experiments}
...
implications of the findings. \Cref{sec:conclusions} concludes the thesis and
